        ...
        <div class="row">
                ...
                <div class="card__wrapper">
                    <div class="client__wrapper text-center">
                        <div class="client__thumb mb-15">
                            <a href="index.php?page=customer-details"><img src="assets/images/avatar/avatar13.png" alt="image"></a>
                        </div>
                        <div class="client__content">
                            <div class="client__meta">
                                <h4 class="mb-8"><a href="index.php?page=customer-details">Sarah Martinez</a></h4>
                            ...
                            <div class="client__btn">
                                <div class="d-flex align-items-center justify-content-center gap-15">
                                    ...
                                    <a class="btn btn-outline-theme-border" href="index.php?page=customer-details">View</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
                <div class="card__wrapper">
                    <div class="client__wrapper text-center">
                        <div class="client__thumb mb-15">
                            <a href="index.php?page=customer-details"><img src="assets/images/avatar/avatar15.png" alt="image"></a>
                        </div>
                        <div class="client__content">
                            <div class="client__meta">
                                <h4 class="mb-8"><a href="index.php?page=customer-details">Amanda Taylor</a></h4>
            ...
            <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
                <div class="card__wrapper">
                    <div class="client__wrapper text-center">
                        <div class="client__thumb mb-15">
                            <a href="index.php?page=customer-details"><img src="assets/images/avatar/avatar.png" alt="image"></a>
                        </div>
                        <div class="client__content">
                            <div class="client__meta">
                                <h4 class="mb-8"><a href="index.php?page=customer-details">Christopher Wilson</a>
                                </h4>
            ...
            <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
                <div class="card__wrapper">
                    <div class="client__wrapper text-center">
                        <div class="client__thumb mb-15">
                            <a href="index.php?page=customer-details"><img src="assets/images/avatar/avatar12.png" alt="image"></a>
                        </div>
                        <div class="client__content">
                            <div class="client__meta">
                                <h4 class="mb-8"><a href="index.php?page=customer-details">Matthew Clark</a></h4>
