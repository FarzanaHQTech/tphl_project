                                    ...
                                    <div class="client__wrapper text-center">
                                        ...
                                        <div class="client__content">
                                            <div class="client__meta">
                                                <h4 class="mb-8"><a href="vendor-details.html.html">Sarah Martinez</a></h4>
                                            ...
                                            <div class="client__btn">
                                                <div class="d-flex align-items-center justify-content-center gap-15">
                                                    ...
                                                    <a class="btn btn-outline-theme-border" href="vendor-details.html.html">View</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
                                <div class="card__wrapper">
                                    <div class="client__wrapper text-center">
                                        ...
                                        <div class="client__content">
                                            <div class="client__meta">
                                                <h4 class="mb-8"><a href="vendor-details.html.html">Amanda Taylor</a></h4>
                            ...
                            <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
                                <div class="card__wrapper">
                                    <div class="client__wrapper text-center">
                                        ...
                                        <div class="client__content">
                                            <div class="client__meta">
                                                <h4 class="mb-8"><a href="vendor-details.html.html">Christopher Wilson</a>
                                                </h4>
                            ...
                            <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
                                <div class="card__wrapper">
                                    <div class="client__wrapper text-center">
                                        ...
                                        <div class="client__content">
                                            <div class="client__meta">
                                                <h4 class="mb-8"><a href="vendor-details.html.html">Matthew Clark</a></h4>
