            ...
            <div class="col-xxl-3">
                <div class="card__wrapper">
                    <div class="d-flex align-items-center justify-content-between gap-15">
                        ...
                        <button type="button" class="btn btn-primary w-100" data-bs-toggle="modal" data-bs-target="#addNewVendor">Add Vendors</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
                ...
                <div class="card__wrapper">
                    <div class="client__wrapper text-center">
                        <div class="client__thumb mb-15">
                            <a href="index.php?page=vendor-details"><img src="assets/images/avatar/avatar13.png" alt="image"></a>
                        </div>
                        <div class="client__content">
                            <div class="client__meta">
                                <h4 class="mb-8"><a href="index.php?page=vendor-details">Sarah Martinez</a></h4>
                            ...
                            <div class="client__btn">
                                <div class="d-flex align-items-center justify-content-center gap-15">
                                    ...
                                    <button type="button" class="btn btn-outline-theme-border" data-bs-toggle="modal" data-bs-target="#editVendor">Edit</button>
                                    <a class="btn btn-outline-theme-border" href="index.php?page=vendor-details">View</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
                <div class="card__wrapper">
                    <div class="client__wrapper text-center">
                        <div class="client__thumb mb-15">
                            <a href="index.php?page=vendor-details"><img src="assets/images/avatar/avatar15.png" alt="image"></a>
                        </div>
                        <div class="client__content">
                            <div class="client__meta">
                                <h4 class="mb-8"><a href="index.php?page=vendor-details">Amanda Taylor</a></h4>
            ...
            <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
                <div class="card__wrapper">
                    <div class="client__wrapper text-center">
                        <div class="client__thumb mb-15">
                            <a href="index.php?page=vendor-details"><img src="assets/images/avatar/avatar.png" alt="image"></a>
                        </div>
                        <div class="client__content">
                            <div class="client__meta">
                                <h4 class="mb-8"><a href="index.php?page=vendor-details">Christopher Wilson</a>
                                </h4>
            ...
            <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
                <div class="card__wrapper">
                    <div class="client__wrapper text-center">
                        <div class="client__thumb mb-15">
                            <a href="index.php?page=vendor-details"><img src="assets/images/avatar/avatar12.png" alt="image"></a>
                        </div>
                        <div class="client__content">
                            <div class="client__meta">
                                <h4 class="mb-8"><a href="index.php?page=vendor-details">Matthew Clark</a></h4>
...
<div class="modal fade" id="addNewVendor" tabindex="-1" aria-labelledby="addNewVendorLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addNewVendorLabel">Add New Customer</h5>
...
<div class="modal fade" id="editVendor" tabindex="-1" aria-labelledby="editVendorLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editVendorLabel">Add New Client</h5>
                <button type="button" class="bd-btn-close" data-bs-dismiss="modal" aria-label="Close"><i
                        class="fa-solid fa-xmark-large"></i></button>
            </div>
            <div class="modal-body">
